...
function QuestionsType2 ({ list }) { //{ question, answer, answerList { word } }
  ...
  const onAnswer = (answerChoose, answerIndex, isHeader) => {
        ...
        {!isDone ? (current == 0 ? (
          <>
            ...
            <div
              ...
              {/* answers */}
              <div className={classes.answers_begin}>
                {answerList.map((answers, index) => (
                  <div
                    onClick={() => onAnswer(answers.word, index, true)}
                    className={`${
                      classes.answerItem
          ...
          <>
            ...
            <div
              ...
              <div className={classes.answers}>
                {answerList.map((answers, index) => (
                  <div
                    onClick={() => onAnswer(answers.word, index, false)}
                    className={`${
                      classes.answerItem
                    } flex-center-col p-5 ${addClassAnswerItem(
                      status,
